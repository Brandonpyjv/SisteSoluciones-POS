...
# El menu muestra en todas las pantallas cuantas ventas estan esperando su factura
# electronica: es lo unico que no puede quedarse a que alguien se acuerde de mirar.
templates.env.globals["pendientes_de_emitir"] = contar_pendientes
